...
import IssuanceInitiation from '../src/IssuanceInitiation';
...
describe('Authorization Request', () => {
  it('Should return Issuance Initiation Request with base URL from URI', () => {
    expect(IssuanceInitiation.fromURI('https://server.example.com?issuer=https%3A%2F%2Fserver%2Eexample%2Ecom&credential_type=https%3A%2F%2Fdid%2Eexample%2Eorg%2FhealthCard&credential_type=https%3A%2F%2Fdid%2Eexample%2Eorg%2FdriverLicense&op_state=eyJhbGciOiJSU0Et...FYUaBy'))
      .toEqual({
