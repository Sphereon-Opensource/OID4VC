...
export class VcIssuerBuilder {
  ...
  public withBatchCredentialEndpoint(
  ...
  public withIssuerDisplay(
    issuerDisplay: IIssuerDisplay | IIssuerDisplay[]
  ): VcIssuerBuilder {
    if (!Array.isArray(issuerDisplay))
      this.metadata.display = this.metadata.display
        ? [...this.metadata.display, issuerDisplay]
        : [issuerDisplay];
    else {
      this.metadata.display = this.metadata.display
        ? [...this.metadata.display, ...issuerDisplay]
  ...
  public withCredentialsSupported(
    credentialSupported: ICredentialSupportedV1_11 | ICredentialSupportedV1_11[]
  ): VcIssuerBuilder {
