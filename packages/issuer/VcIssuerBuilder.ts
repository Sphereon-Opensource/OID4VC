...
import {ICredentialIssuerMetadataParametersV1_11, ICredentialSupportedV1_11, IIssuerDisplay} from "./types/IVcIssuer";
...
export class VcIssuerBuilder {
  ...
  public withCredentialsSupported(credentialSupported: ICredentialSupportedV1_11| ICredentialSupportedV1_11[]): VcIssuerBuilder {
    if (!Array.isArray(credentialSupported))
      this.metadata.credentials_supported = this.metadata.credentials_supported? [...this.metadata.credentials_supported, credentialSupported]: [credentialSupported]
    else {
      this.metadata.credentials_supported = this.metadata.credentials_supported? [...this.metadata.credentials_supported, ...credentialSupported]: credentialSupported
    }
    return this
