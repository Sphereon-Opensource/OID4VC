...
import { CredentialSupportedV1_11Builder } from './CredentialSupportedV1_11Builder'
import { VcIssuer } from './VcIssuer'
import { VcIssuerBuilder } from './VcIssuerBuilder'
import {createCredentialOfferDeeplink} from "./functions/CredentialOffer";
...
function buildVcIssuer() {
  const credentialsSupported: ICredentialSupportedV1_11 = new CredentialSupportedV1_11Builder()
    ...
    .withIssuerCredentialSubjectDisplay(process.env.credential_subject_display_key1 as string, {
