...
import {
  ...
  INITIATION_TEST_URI_V1_0_08, INITIATION_TEST_URI_V1_0_15,
...
describe('Issuance Initiation V1_0_15', () => {
  it('Should return Issuance Initiation Request with base URL from https URI', async () => {
    expect(await CredentialOfferClientV1_0_15.fromURI(INITIATION_TEST_HTTPS_URI_V1_0_15_PRE_AUTH)).toEqual({
