...
export interface CredentialOfferJwtVcJsonLdAndLdpVcV1_0_11 extends CredentialOfferPayloadV1_0_11 {
  credential_definition: IssuerCredentialDefinition;
}

export interface CredentialOfferJwtVcJsonV1_0_11 extends CredentialOfferPayloadV1_0_11 {
  credentials: (
    | {
