...
beforeEach(async () => {
  ...
  rp = RP.builder({ requestVersion: SupportedVersion.SIOPv2_V1 }) // TODO why is the version not set correctly { requestVersion: SupportedVersion.JWT_VC_PRESENTATION_PROFILE_v1 })
    ...
    .withCreateJwtCallback(internalSignature(TestVectors.verifierHexPrivateKey, TestVectors.verifierDID, TestVectors.verifierKID, SigningAlgo.ES256)) //EDDSA
  ...
  op = OP.builder()
    ...
    .withVerifyJwtCallback(verifyJwtCallback)
    .addSupportedVersion(SupportedVersion.JWT_VC_PRESENTATION_PROFILE_v1) //SupportedVersion.JWT_VC_PRESENTATION_PROFILE_v1
    .build()
})
...
async function createAuthRequest(): Promise<AuthorizationRequest> {
  return await rp.createAuthorizationRequest({
    ...
    jwtIssuer: { method: 'did', alg: SigningAlgo.ES256, didUrl: TestVectors.verifierKID }, //SigningAlgo.EDDSA,
    claims: {
      propertyValue: {
        vp_token: {
          dcql_query: JSON.stringify(TestVectors.parsedDcqlQuery),
...
class TestVectors {
  ...
  public static issuerKID = `${TestVectors.issuerDID}#0` //#key-1
  ...
  public static holderDID =
    ...
    'did:jwk:eyJhbGciOiJFUzI1NiIsInVzZSI6InNpZyIsImt0eSI6IkVDIiwiY3J2IjoiUC0yNTYiLCJ4IjoiZjgzT0ozRDJ4RjFCZzh2dWI5dExlMWdITXpWNzZlOFR1czl1UEh2UlZFVSIsInkiOiJ4X0ZFelJ1OW0zNkhMTl90dWU2NTlMTnBYVzZwQ3lTdGlrWWpLSVdJNWEwIn0'
  public static holderKID = `${TestVectors.holderDID}#0` //#key-1
  ...
  //'did:jwk:eyJhbGciOiJFUzI1NiIsInVzZSI6InNpZyIsImt0eSI6IkVDIiwiY3J2IjoiUC0yNTYiLCJ4IjoiaTlBdmpJMFdjUXo5NF9aVkVDazVrS21kSEFEU2RWNGRKZ1RNN0ROYkNJayIsInkiOiJJZGtyWktUcWdmNE1ZY3hUbHlIM3ZJMkdHYjJXYWM1Z0V1Y0lQaTFfRmtnIn0'
  'did:jwk:eyJhbGciOiJFUzI1NiIsInVzZSI6InNpZyIsImt0eSI6IkVDIiwiY3J2IjoiUC0yNTYiLCJ4IjoiZjgzT0ozRDJ4RjFCZzh2dWI5dExlMWdITXpWNzZlOFR1czl1UEh2UlZFVSIsInkiOiJ4X0ZFelJ1OW0zNkhMTl90dWU2NTlMTnBYVzZwQ3lTdGlrWWpLSVdJNWEwIn0'
  public static verifierKID = `${TestVectors.verifierDID}#0` //#key-1
  ...
  public static async init() {
    ...
    TestVectors.issuerPrivateKey = toString(fromString(TestVectors.issuerJwk.d, 'base64url'), 'hex')
    TestVectors.issuerPublicKey = toString(fromString(TestVectors.issuerJwk.x, 'base64url'), 'hex')
    TestVectors.issuerHexPrivateKey = TestVectors.issuerPrivateKey//`${TestVectors.issuerPrivateKey}${TestVectors.issuerPublicKey}`
...
//'..GbDjvmHRx6ndjsV8AXAJDJ9SJTXDN_IEETy33kvh8ddqX1-fROagpCQBI5UopWKPTB6xz6dswXOyk2eHYuPsBQ'
'..wbvTBasJYgM1SK3c5yU05T1JVnlnmmFVQkIL6ftbCaAxUcR5fI9B-TkxeXKYNgNQt0SBSCi0Prqgvh-GtZ-dBw'
  ...
  public static idTokenPayload = {
    ...
    _vp_token: {
      dcql_query: JSON.stringify(TestVectors.parsedDcqlQuery) //JSON.stringify(
    }
  }
