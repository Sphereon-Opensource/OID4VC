...
import { CredentialOfferPayloadV1_0_15, OpenId4VCIVersion } from '../types'
...
describe('CredentialOfferUtil should', () => {
  ...
  it('get client_id from JWT pre-auth code offer', () => {
    const offer: CredentialOfferPayloadV1_0_15 = {
      ...
      credential_configuration_ids: ['CTWalletCrossPreAuthorisedInTime'],
      grants: {
        'urn:ietf:params:oauth:grant-type:pre-authorized_code': {
          'pre-authorized_code':
  ...
  it('get client_id from JWT authorization code offer', () => {
    const offer: CredentialOfferPayloadV1_0_15 = {
      credential_issuer: 'https://conformance-test.ebsi.eu/conformance/v3/issuer-mock',
      credential_configuration_ids: ['CTWalletCrossAuthorisedInTime'],
      grants: {
        authorization_code: {
          issuer_state:
